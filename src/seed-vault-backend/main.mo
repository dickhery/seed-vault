...
persistent actor Self {
  ...
  // Use backtick escape so the candid field name remains `class` as expected by XRC.
        ...
        switch (found) {
          ...
          case (?seed) {
            ...
            try {
              ...
              audit("Retrieved ciphers and vetKD key for seed and image " # normalizedName, caller);
              ...
              #err("Failed to retrieve seed and image");
            };
          };
        };
      };
        ...
        switch (found) {
          ...
          case (?seed) {
            ...
            try {
              ...
              audit("Retrieved ciphers for seed and image " # normalizedName, caller);
