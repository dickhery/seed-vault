...
persistent actor Self {
  ...
  let RATE_LIMIT : Nat = 1_600; // operations per reset interval (300% increase from 400)
  let GLOBAL_RATE_LIMIT : Nat = 16_000; // overall operations per reset interval (300% increase from 4,000)
